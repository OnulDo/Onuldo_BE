...
-- Term 테이블 약관 추가
INSERT IGNORE INTO term(type, title, effective_date, content)
VALUES
...
INSERT IGNORE INTO term(type, title, effective_date, content)
VALUES
    ('AGE_14', '만 14세 이상 확인', '2026-07-28', null),
    ('MARKETING', '마케팅 정보 수신 동의', '2026-07-28', null);
...
SELECT
    '아침 운동',
    '매일 아침 운동을 인증하는 챌린지',
    '## 이 챌린지는?\n아침 운동으로 하루를 시작하는 습관을 만드는 챌린지입니다.\n\n## 하면 좋은 점\n- 몸이 먼저 깨어나요\n- 오전 집중력이 올라가요\n- 꾸준한 루틴을 만들기 쉬워요',
    'https://together-mud.kakaocdn.net/dn/ddUiy9/btsdGABygpb/MsARp4M5vZdcumFmyHKoN1/c360.jpg',
...
SELECT
    '독서 습관',
    '매일 독서하는 습관을 만드는 챌린지',
    '## 이 챌린지는?\n매일 책을 읽는 시간을 확보해 독서 습관을 만드는 챌린지입니다.\n\n## 하면 좋은 점\n- 짧은 시간에도 꾸준히 읽는 습관이 생겨요\n- 출퇴근 전후의 자투리 시간을 잘 쓰게 돼요',
    'https://together-mud.kakaocdn.net/dn/ddUiy9/btsdGABygpb/MsARp4M5vZdcumFmyHKoN1/c360.jpg',
...
SELECT
    '건강한 아침 식사',
    '매일 건강한 식단을 인증하는 챌린지',
    '## 이 챌린지는?\n매일 건강한 아침 식사를 챙기며 식습관을 바꾸는 챌린지입니다.\n\n## 하면 좋은 점\n- 하루 시작을 안정적으로 열 수 있어요\n- 규칙적인 식사 습관이 생겨요',
    'https://together-mud.kakaocdn.net/dn/ddUiy9/btsdGABygpb/MsARp4M5vZdcumFmyHKoN1/c360.jpg',
